...
We shall start with an example dataset about Maize and Ligule Development. [Add description of data and maybe link to paper here]
...
> We shall start with an example dataset about ER (Endocrine Reticulum) cell death response. [Add description of data and maybe link to paper here]
> 
> * [All_Counts_ER.txt](data/All_Counts_ER.txt)
> 
> ```{bash eval=FALSE}
...
> * The column names are prefixed with the treatment group (e.g. `B-3` is B, `3I_S4_L006` is 3 hours, `48mkII_S28_L007` is 48 hours mock.)
...
Think through what kinds of plots may tell you something about the dataset. This example plots the data to identify any outliers.
