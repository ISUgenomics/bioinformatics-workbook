...
Note that this is not an exact comparison, as I used different genome's from the same species. Here I compare my results to the published results demonstrating genes under positive selection in Escherichia coli. [Table of previous study](https://genome.cshlp.org/content/17/9/1336/T2.expansion.html)
