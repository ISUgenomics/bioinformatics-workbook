...
### Data analysis
  * [Gene orthology, synteny, and visualization with opscan, iadhore, and circos](ComparativeGenomics/Gene_Orthology_And_Synteny.md)
  * [Gene orthology, synteny, and visualization with orthofinder, iadhore, and circos](ComparativeGenomics/OrthofinderSynteny.md)
  * [Gene overlap significance testing with R Gene_overlap package](ComparativeGenomics/Gene_Category_Overlap_Fishers_exact_testing.md)
  * [Helitron identification in a genome sequence](ComparativeGenomics/Helitron_Scanner.md)    
  * [DNA transposon annotation with Inverted-Repeats Finder](ComparativeGenomics/InvertedRepeatsFinderForDNATransposonAnnotation.md)
  * [LTR retrotransposon annoatation with LTR-Finder](ComparativeGenomics/LTRFinder.md)
  * [Repeat annotation from next-gen sequencing reads using RepeatExplorer](ComparativeGenomics/RepeatExplorer.md)
  * [De-novo repeat identification and annotation from genome assemblies using RepeatModeler and RepeatMasker ](ComparativeGenomics/RepeatModeler_RepeatMasker.md)
  * [Tandem duplication annotation in a genome assembly using Mummer and RedTandem](ComparativeGenomics/Tandem_Duplication_Detection.md)
