---
title: "Submitting a BioProject, BioSample, Genome, and Annotation to NCBI"
layout: single
...
I submitted multiple biosamples for this project using the Excel file download.I filled out as much information as possible, though only a few entries in this form are required.
...
Then you will need to answer whether you assembled the genome or if you are someone depositing the genome for someone else. If you assembled the genome then, you would select original. 
...
wget https://github.com/phasegenomics/juicebox_scripts/blob/master/juicebox_scripts/makeAgpFromFasta.py
...
```bash
#Download and more detailed inforamtion on table2asn is here: https://www.ncbi.nlm.nih.gov/genbank/table2asn/
